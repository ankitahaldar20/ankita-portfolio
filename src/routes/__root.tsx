...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ankita Haldar — CS/AI Engineer & Full-Stack Developer" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Ankita Haldar — CS/AI Engineer" },
      {
        ...
        content:
          "AI + full-stack developer. LLMs, semantic search, React, FastAPI. Currently open to entry-level SDE / AI-ML roles.",
      },
